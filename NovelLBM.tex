...
Importantly, we show in figure~\ref{fig:wiParameterStudy}~(b) that this very good agreement is independent of the shuffling parameter $\alpha_\text{s}$.
	\begin{figure}[H]
		...
		(b) The error is negligibly small and independent of the shuffling parameter $\alpha_\text{s}$. Shown at \SI{1}{\per\second} and .}
		\label{fig:wiParameterStudy}
	\end{figure}\todo{1e5; maybe write this in legend}
