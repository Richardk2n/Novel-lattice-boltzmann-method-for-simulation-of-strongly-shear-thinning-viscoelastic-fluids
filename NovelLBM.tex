...
\begin{equation}
	B_i = w_i\left(\frac{\vec{c}_i\vec{c}_i}{2c_\text{s}^4}-\frac{\uT}{2c_\text{s}^2}\right):\ma{\tau}.
\end{equation}
Here, $w_i$ are the lattice weights, $c_\text{s}$ is the lattice speed of sound and $\ma{\tau}$ is the polymer stress tensor. The colon denotes the Frobenius inner product.
