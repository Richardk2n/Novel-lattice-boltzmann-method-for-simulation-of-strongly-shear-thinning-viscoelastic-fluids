...
We note that extended forms of the PTT model with a Mittag-Leffler instead of an exponential function have been studied as well \cite{ferras2019}.
...
The obtained parameters are given in table~\ref{tab:PTTparameters}.
	\begin{table}[H]
		...
		\begin{tabular}{c|c|c|c|c}
			...
			\hline
			alginate \num{4}\% & \num{48.2\pm0.4e3} & \num{343 \pm 4} & \num{0.545 \pm 0.010} & $4.8 \times 10 ^{ 4 }$\\
			methyl c. \num{0.49}\% & \num{18.7\pm0.4} & \num{0.344\pm0.003} & \num{0.270\pm0.003} & 18.7\\
			methyl c. \num{0.59}\% & \num{32.5\pm0.7} & \num{0.433\pm0.004} & \num{0.365\pm0.004} & 32.5\\
			methyl c. \num{0.83}\% & \num{81\pm2} & \num{0.714\pm0.009} & \num{0.496\pm0.006} & 81
		\end{tabular}
		...
		\SG{ add a column with $R_ \eta $ }}\RK{would be identical to the content of the $\eta_p$ column, also would be used before introduced} \SG{ Stimmt, aber ich will es auf einen Blick sichtbar machen }
...
\SG{ wo don't actually show that $R_ \eta  $ determines stability? }\RK{we do not. We could do a few simulations with $\alpha_s = 0$ and increasing $R_\eta$ until the sim breaks if you want} \SG{ wie besprochen, bau einfach die Zitate ein, das reicht dann. }
...
\SG{ and vice versa: make sure that all papers discussed here are also cited in the introduction }\RK{gupta2015\_2 not in intro} \SG{ dann setz einfach die Zitate so rein, wie du sie fuer passend haeltst. }
...
In the case of alginate, we speed up the convergence and start from a situation in which the polymers are pre-stretched \SG{ give details }\RK{initialized to the semianalytical solution} \SG{ schreib am besten eine Referenz auf die Gleichung hin, muesste ja im Appendix stehen. }.
...
Furthermore, in agreement with \cite{malaspinas2010}, also the L2 error is defined differently than above, namely:
	...
	\end{equation}
At this point, we mention that there is a typographic mistake in eq.~(61) of \cite{malaspinas2010} where the prefactor should 8 instead of 4. \SG{ stimmt das so? }
