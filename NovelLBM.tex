...
\begin{equation}
	...
	\end{cases}
\end{equation}
yields the first normal stress difference $N_1$ as follows. The second normal stress difference is proportional to $\xi$ and therefore $0$.
\begin{equation}
...
We start with the Cauchy momentum equation (neglecting gravity), which reads as follows.
\begin{equation}
