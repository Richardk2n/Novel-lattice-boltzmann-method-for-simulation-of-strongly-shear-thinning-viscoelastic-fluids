...
\SG{ and vice versa: make sure that all papers discussed here are also cited in the introduction }\RK{gupta2015\_2 not in intro} \SG{ dann setz einfach die Zitate so rein, wie du sie fuer passend haeltst. }\RK{done}
...
\RK{There are three, proceeds to name two} \SG{ ? }\todo{do}
...
\label{sec:supplementaryFigures}
	...
	\end{figure}\todo{reference in main text}
