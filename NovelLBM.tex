...
\begin{document}
	...
	\section{Analytical solution for PTT}\label{app:PTT}
	...
	\end{align}
	With this, $\dot{\gamma}$ can be found for each $r$ numerically. With $\dot{\gamma} = \partial_ru$, the result can be numerically integrated to find the velocity profile. To do this, the radial distance needs to be discretized. We split it into \num{1e5} steps and interpolate between them as needed.
