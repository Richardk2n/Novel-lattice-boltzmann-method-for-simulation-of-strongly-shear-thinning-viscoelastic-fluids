...
def process(i):
    ...
    r[0] += L0 / 2
    r[-1] -= L0 / 2
    PTT.alginate.prepareVelocityProfile(R, G, PTT.pipe)
    ...
    plt.legend()
    plt.savefig("../plots/3DAlginateU.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()
    ...
    # plt.legend()
    plt.savefig("../plots/3DAlginateErr.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()
