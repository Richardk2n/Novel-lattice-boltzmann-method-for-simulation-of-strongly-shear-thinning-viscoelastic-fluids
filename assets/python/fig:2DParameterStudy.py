...
def process(index):
    ...
    plt.legend()
    plt.savefig(f"../plots/2DParameterStudyU{i}.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()
    ...
    plt.ylabel(r"$error$")
    plt.legend()
    plt.savefig(f"../plots/2DParameterStudyErr{i}.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()
...
if __name__ == "__main__":
    ...
    plt.ylabel(r"$error$")
    plt.savefig("../plots/2DParameterStudyErr.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()
