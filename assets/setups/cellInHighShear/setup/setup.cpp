...
void example(SimulationOptions& options, Parameters& parameters) {
	...
	const int id = raw["id"];
	const string path_files = fmt::format("/tp6-gekle/nas/bt307867/cellsim/{}_{}/{}/", "cellInShear", "2024-02-05", id);
	//const string path_files = fmt::format("{}_{}/{}/", "cellInShear", "2024-02-05", id);
	 ...
	 */
	const float dtScale = 1e-1;  // decrease timestep
	...
	tetraPrecisionFloat youngsModulusSI = 1e3; //Pa
