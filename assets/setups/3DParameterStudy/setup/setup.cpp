...
void example(SimulationOptions& options, Parameters& parameters) {
	...
	const string path_files = fmt::format("3DParameterStudy/{}/", id);
	...
	const double px = 4*Vmax/pow(R, 2)*(eta_polymer + eta_solvent_SI/mu0); // This as a approximation for small eta_s
