...
void example(SimulationOptions& options, Parameters& parameters) {
	...
	const long numberSteps = 200'000;//(long)(10000000*25/dtScale/ReScale);
	const uint vtkInterval = 2'000;//(uint)(500*5*25/dtScale/ReScale);  // every vtkInterval steps a vtk file is written
